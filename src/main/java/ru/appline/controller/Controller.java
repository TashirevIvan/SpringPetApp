...
public class Controller {
    ...
    public String createPet(@RequestBody Pet pet) {
        int petId = newId.getAndIncrement();
        petModel.add(pet, petId);
        return "Congratulations you created new pet with id = " + petId;
    }
    ...
    public void editPet(@RequestBody Map<String, Pet> editedPetMap) {
        petModel.editPetList(editedPetMap);
    }
}
